      ...
      <div class="tm-top-container">
        ...
        <nav id="tmNav" class="tm-nav">
          ...
          <ul class="tm-nav-links">
            ...
            <li class="tm-nav-item">
              <a href="#" data-linkid="3" data-align="left" class="tm-nav-link">Administrador</a>
            </li>
          </ul>
        </nav>
                    ...
                    <div class="box-body">
                      ...
                      <form>                          
                        ...
                        <script>    
                          ...
                          Destino:
                          <input type="text" id="destino" name="destino" value="" placeholder="Destino"><br/>

                          <input type="hidden" id="form_sent" name="form_sent" value="true"><br/>
                          <input type="submit" id="btn_submit" value="Buscar viaje"><br/>              
                      </form>
                        ...
                        <?php
                          ...
                          $rs = mysqli_query($mysqli, $strsql) or die(mysqli_error());
